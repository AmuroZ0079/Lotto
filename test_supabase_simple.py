#!/usr/bin/env python3
"""
ไฟล์ทดสอบการเชื่อมต่อ Supabase (แบบง่าย)
"""
...
def test_supabase_connection():
    ...
    try:
        ...
        print("SUCCESS: เชื่อมต่อ Supabase สำเร็จ!")
        print(f"SUCCESS: พบข้อมูล: {len(result.data)} รายการ")
        
        return True
        
    except ImportError:
        print("ERROR: ไม่พบโมดูล supabase")
